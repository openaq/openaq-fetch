...
async function promisePostRequest (url, formParams, headers) {
  const response = await getter.post(url, {
    form: formParams,
    headers: headers,
    responseType: 'text',
    encoding: 'latin1',
...
export async function fetchData (source, cb) {
  ...
  const dataParams = {
    dataStr: dateNow.toFormat('dd/MM/yyyy'),
    horaStr: dateNow.toFormat('HH:mm'),
  ...
  try {
    ...
    const allParams = Object.values(paramCodes).map((p) =>
      promisePostRequest(
        source.url +
          '/conDadosHorariosPorParametro.do?method=executarImprimir',
        { ...dataParams, nparmtsSelecionados: p },
        { cookie: cookie }
      )
        .catch((error) => {
          log.warn(error || 'Unable to load data for parameter');
          return null;
        })
...
function parseParams (data) {
  ...
  const timeStamps = $($('tbody').last().children()[2]).children();
  const dataRows = $('tbody').last().children().slice(3);
  ...
  dataRows.each((_, row) => {
    ...
    if (!Object.keys(coordinates).includes(location)) {
      ...
      const base = {
        ...
        location: location,
        attribution: [
          { name: 'CETESB', url: 'http://cetesb.sp.gov.br/' },
        ],
...
export const coordinates = {
  ...
  'S.José Campos': {
    latitude: -23.18788733,
    longitude: -45.87119762,
  },
  'S.José Campos-Jd.Satelite': {
    latitude: -23.22364548,
    longitude: -45.8908,
  },
  'S.José dos Campos-Vista Verde': {
    latitude: -23.18369735,
    longitude: -45.83089698,
  },
  Taubaté: { latitude: -23.03235096, longitude: -45.57580502 },
  'Ribeirão Preto': {
    latitude: -21.15394189,
    longitude: -47.82848053,
  },
  'Ribeirão Preto-Centro': {
    latitude: -21.17706594,
    longitude: -47.81898767,
  },
  Americana: { latitude: -22.7242527, longitude: -47.33954929 },
  'Campinas-Centro': {
    latitude: -22.9025248,
    longitude: -47.05721074,
  },
  'Campinas-Taquaral': {
    latitude: -22.87461894,
    longitude: -47.05897276,
  },
  'Campinas-V.União': {
    latitude: -22.94672842,
    longitude: -47.11928086,
  },
  ...
  'Paulínia-Sta Terezinha': {
    latitude: -22.780208950215425,
    longitude: -47.139036494729396,
  },
  Perus: {
    latitude: -23.413209739894405,
    longitude: -46.756053990921224,
  },
  'Rio Claro-Jd.Guanabara': {
    latitude: -22.43904378887939,
    longitude: -47.58147331085557,
  },
  Piracicaba: { latitude: -22.70122234, longitude: -47.64965269 },
  'Santa Gertrudes': {
    latitude: -22.45995527,
    longitude: -47.53629834,
  },
  Cambuci: { latitude: -23.56770841, longitude: -46.61227286 },
  'Capão Redondo': {
    latitude: -23.66835615,
    longitude: -46.78004338,
  },
  Carapicuíba: { latitude: -23.53139503, longitude: -46.83577973 },
  Centro: { latitude: -23.54780616, longitude: -46.6424145 },
  'Cerqueira César': {
    latitude: -23.55354256,
    longitude: -46.67270477,
  },
  'Cid.Universitária-USP-Ipen': {
    latitude: -23.56634178,
    longitude: -46.73741428,
  },
  Congonhas: { latitude: -23.61632008, longitude: -46.66346553 },
  Diadema: { latitude: -23.68587641, longitude: -46.61162193 },
  'Grajaú-Parelheiros': {
    latitude: -23.77626598,
    longitude: -46.69696108,
  },
  Guarulhos: { latitude: -23.46320938, longitude: -46.4962136 },
  'Guarulhos-Paço Municipal': {
    latitude: -23.45553426,
    longitude: -46.5185334,
  },
  'Guarulhos-Pimentas': {
    latitude: -23.44011701,
    longitude: -46.40994877,
  },
  Ibirapuera: { latitude: -23.59184199, longitude: -46.6606875 },
  Interlagos: { latitude: -23.68050765, longitude: -46.67504316 },
  'Itaim Paulista': {
    latitude: -23.50154736,
    longitude: -46.42073684,
  },
  Itaquera: { latitude: -23.58001483, longitude: -46.46665141 },
  Lapa: { latitude: -23.5093971, longitude: -46.70158164 },
  'Marg.Tietê-Pte Remédios': {
    latitude: -23.51870583,
    longitude: -46.74332004,
  },
  Mauá: { latitude: -23.668549, longitude: -46.46600027 },
  'Mogi das Cruzes': {
    latitude: -23.51817223,
    longitude: -46.18686057,
  },
  Mooca: { latitude: -23.54973405, longitude: -46.60041665 },
  'N.Senhora do Ó': {
    latitude: -23.48009871,
    longitude: -46.69205192,
  },
  Osasco: { latitude: -23.52672142, longitude: -46.79207766 },
  'Parque D.Pedro II': {
    latitude: -23.54484566,
    longitude: -46.62767559,
  },
  'Pico do Jaraguá': {
    latitude: -23.4562689,
    longitude: -46.76609776,
  },
  Pinheiros: { latitude: -23.56145989, longitude: -46.70201651 },
  'S.André-Capuava': {
    latitude: -23.6398037,
    longitude: -46.49163677,
  },
  'S.André-Centro': {
    latitude: -23.64561638,
    longitude: -46.53633467,
  },
  'S.André-Paço Municipal': {
    latitude: -23.6569942,
    longitude: -46.53091876,
  },
  'S.Bernardo-Centro': {
    latitude: -23.69867109,
    longitude: -46.54623219,
  },
  'S.Bernardo-Paulicéia': {
    latitude: -23.67135396,
    longitude: -46.58466789,
  },
  'S.Miguel Paulista': {
    latitude: -23.49852641,
    longitude: -46.44480278,
  },
  Santana: { latitude: -23.50599272, longitude: -46.6289603 },
  'Santo Amaro': { latitude: -23.65497723, longitude: -46.70999838 },
  'São Caetano do Sul': {
    latitude: -23.61844277,
    longitude: -46.55635394,
  },
  'Taboão da Serra': {
    latitude: -23.60932386,
    longitude: -46.75829437,
  },
  'Cubatão-Centro': {
    latitude: -23.87902673,
    longitude: -46.41848336,
  },
  'Cubatão-V.Parisi': {
    latitude: -23.84941617,
    longitude: -46.38867624,
  },
  'Cubatão-Vale do Mogi': {
    latitude: -23.83158901,
    longitude: -46.36956879,
  },
  Santos: { latitude: -23.9630572, longitude: -46.32117009 },
  'Santos-Ponta da Praia': {
    latitude: -23.98129516,
    longitude: -46.30050959,
  },
