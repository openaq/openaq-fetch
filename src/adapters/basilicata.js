...
let bearerAuth = await getBearerAuth().then(bearerAuth => bearerAuth);

const STATIONS_URL = 'https://arpabaegis.arpab.it/Datascape/v3/locations?category=All&basin_org_id&basin_id&region_id&province_id&station_id&filter_central_id&filter_id&_=1677195752467';
const MEASUREMENTS_URL = 'https://arpabaegis.arpab.it/Datascape/v3/elements?station_id=951100&longitude&latitude&category=1&ui_culture=en&field=ElementName&field=Time&field=Value&field=Decimals&field=MeasUnit&field=Trend&field=StateId&field=IsQueryable&filter_central_id&filter_id&_=1677195752563';
