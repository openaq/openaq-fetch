...
import { ADAPTER_NAME_INVALID, AdapterError, ADAPTER_MODULE_INVALID, ADAPTER_RESOLVE_ERROR, ADAPTER_NOT_FOUND } from './errors';
 ...
 */
export function prepareCompleteResultsMessage (stream, fetchReport, {dryrun, doSaveToDB}) {
  return stream.map(
    measurements => {
