 ...
 * @param {DataStream} measurements An stream of measurements to potentially convert units of
 * @return {DataStream} An stream of measurements converted to system-preferred units
 */
export function convertUnits (stream) {
  return stream.each(unifyMeasurementUnits);
}
